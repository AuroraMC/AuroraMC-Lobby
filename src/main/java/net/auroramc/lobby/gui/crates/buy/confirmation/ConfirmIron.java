...
public class ConfirmIron extends GUI {
    ...
    public ConfirmIron(AuroraMCLobbyPlayer player, int amount) {
        ...
        this.setItem(2, 6, new GUIItem(Material.STAINED_CLAY, "&a&lConfirm", 1, ";&d" + (CrateUtil.IRON_CRATE_PRICE * amount) + " Tickets&r&f will be taken from your account.", (short)5));
    }
